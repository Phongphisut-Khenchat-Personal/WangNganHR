        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryExpected = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationNotes_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Production Department", true, "ฝ่ายผลิต" },
                    { 2, "Quality Control", true, "ฝ่ายควบคุมคุณภาพ" },
                    { 3, "Warehouse & Logistics", true, "ฝ่าย Logistics" },
                    { 4, "Maintenance", true, "ฝ่ายซ่อมบำรุง" },
                    { 5, "Human Resources", true, "ฝ่าย HR" },
                    { 6, "Administration", true, "ฝ่ายธุรการ" }
                });
